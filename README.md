...
- I used Apache Beam Mean and Count combiners for all calculations  
...
The goal is to compute rating summaries for movies and genres and to enrich the data with additional insights.
...
- A new field called rating band is added  
  - **high** for movies with a rating of four point zero or higher  
  - **medium** for movies with ratings between three and three point nine nine  
  - **low** for movies with a rating below three  
...
- The pipeline identifies the ten genres with the highest average rating  
- This is done using Apache Beam Top combiner  
